...
class PipeShell(object):
    ...
    def __init__(self, *cmd):
        ...
        if PipeShell.set_sigchld_handler:
            # Prevent Zombies from taking over the world
            signal.signal(signal.SIGCHLD, PipeShell.sigchld_handler)
            PipeShell.set_sigchld_handler = False
    ...
    def env(self, **kw):
        ...
        self._env.update({k: v for k, v in kw.iteritems()})
        return self
